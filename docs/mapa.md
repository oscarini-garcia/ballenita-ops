...
- **`app/`** v0.34.1 — PWA para gestionar los eventos del grupo de amigos — gastos estilo Splitwise entre familias, offline-first. 🐳
  772 pruebas en 83 ficheros · `npm test` → `vitest run`
...
- `native.js` — Puente con las capacidades nativas (Capacitor).
  ↳ urlDelManifiestoOta, isNative, tap, share, checkForOtaUpdate, versionInstalada · +8 más
