...
- **`app/`** v0.56.0 — PWA para gestionar los eventos del grupo de amigos — gastos estilo Splitwise entre familias, offline-first. 🐳
  1077 pruebas en 116 ficheros · `npm test` → `vitest run`
