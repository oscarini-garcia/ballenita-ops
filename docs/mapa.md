...
- **`app/`** v0.53.0 — PWA para gestionar los eventos del grupo de amigos — gastos estilo Splitwise entre familias, offline-first. 🐳
  1056 pruebas en 114 ficheros · `npm test` → `vitest run`
...
- **§14.10** Cromo de la app: cabecera, barra inferior y modales → `App.jsx`, `DiasScreen.jsx`, `EventSettingsScreen.jsx`, `PlanesScreen.jsx`, `alojamientos.js`, `scrollLock.js` · +1 más
