/**
 * El modal que se enseña mientras la PWA se actualiza a la última versión.
 *
 * Enseña los tres pasos como una lista con el que va en curso marcado, y la
 * versión que está corriendo ahora mismo, que es el dato que uno viene a
 * comprobar. Antes era un solo rótulo que cambiaba y parecía un parpadeo.
 */
