...
const DIBUJOS = {
  ...
  // La flecha de deshacer: no es la papelera —lo que se quita es una **marca**,
  // no un hecho que alguien escribiera— ni el aspa, que aquí cierra cosas.
  deshacer: <><path d="M4 9.5h9.8a5.5 5.5 0 1 1 0 11H8.4" /><path d="M8.2 5 3.5 9.5l4.7 4.5" /></>,
