...
export function estadoSync(sync = {}) {
  if (!sync.isConfigured) {
    return {
      color: 'var(--ink-faint)',
      title: 'Solo local (sin sincronización)',
      detalle: isNative()
  ...
  if (sync.dirty) {
    return { color: 'var(--gold)', title: 'Cambios sin sincronizar', detalle: 'Toca para subirlos ahora.', checking: false }
  }
  return { color: 'var(--owed)', title: 'Conectado y al día', detalle: 'Nada pendiente de subir.', checking: false }
}
