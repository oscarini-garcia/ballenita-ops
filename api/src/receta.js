...
export const INSTRUCCION_ARREGLAR = [
  ...
  'y el nombre del ingrediente **sin la cantidad delante**. «tres pinchos de wagyu»',
  'son 3, ud, «pinchos de wagyu».',
  'NO corrijas faltas de ortografía ni cambies mayúsculas ni el singular o el',
  'plural: deja el nombre tal como está escrito, quitándole solo la cantidad.',
  'Un nombre raro puede estar puesto a propósito.',
