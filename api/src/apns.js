 ...
 *
 * Es el cable, y nada más: aquí no se decide a quién se avisa ni qué dice el
 * aviso —eso está en `avisos.js` del lado de la app y en quien llama a
 * `enviarAviso` del lado del Worker—. Aquí solo está cómo llega.
 *
 * Portado de `garciadoral-ops`, que ya lo tenía resuelto, con dos cambios: el
 * asunto por defecto es el paquete de esta app y las variables llevan sus
 * nombres. Lo demás se queda igual **incluidos los comentarios**, porque cada
 * uno de ellos es media tarde de alguien.
 *
